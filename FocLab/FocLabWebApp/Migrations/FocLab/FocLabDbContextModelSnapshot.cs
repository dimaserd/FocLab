...
namespace FocLab.Migrations.FocLab
{
    ...
    partial class FocLabDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FocLab.Model.External.FocLabDbFile", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FocLab.Model.External.FocLabUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FocLab.Model.Entities.Chemistry.ChemistryMethodFile", b =>
                {
                    b.HasOne("FocLab.Model.External.FocLabDbFile", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("FocLab.Model.Entities.Chemistry.ChemistryTask", b =>
                {
                    b.HasOne("FocLab.Model.External.FocLabUser", "AdminUser")
                        .WithMany()
                    ...
                    b.HasOne("FocLab.Model.External.FocLabUser", "PerformerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FocLab.Model.Entities.Chemistry.ChemistryTaskExperiment", b =>
                {
                    ...
                    b.HasOne("FocLab.Model.External.FocLabUser", "Performer")
                        .WithMany()
