...
namespace FocLab.Model
{
    ...
    {
        const string ServerConnection = "Server=ms-sql-9.in-solve.ru;Database=1gb_foclab-netcore;Persist Security Info=True;Pooling=false;User ID=1gb_dimaserd;Password=add3835b723";
